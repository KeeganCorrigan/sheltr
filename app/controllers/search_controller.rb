class SearchController < ApplicationController
  def index
    ...
    @locations = payload[:results].map do |place|
      conn_2 = Faraday.get "https://maps.googleapis.com/maps/api/place/details/json?key=#{ENV["GOOGLE_API_KEY"]}&place_id=#{place[:place_id]}&fields=formatted_address,formatted_phone_number,website,name"
